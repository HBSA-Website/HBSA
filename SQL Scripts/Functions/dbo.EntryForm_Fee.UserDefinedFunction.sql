...
if exists (select ROUTINE_NAME from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'EntryForm_Fee')
	drop function EntryForm_Fee
GO

create function EntryForm_Fee
	(@ClubID int
	)
returns money
