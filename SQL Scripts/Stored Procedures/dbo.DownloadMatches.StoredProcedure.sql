USE HBSA
GO
if exists (select routine_name from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'DownloadMatches')
	drop procedure dbo.DownloadMatches
go

create procedure dbo.DownloadMatches
