<%@ Page Title="Player Registration Request" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" 
         ClientIDMode="Static" CodeBehind="PlayerRegistrationRequest.aspx.vb" Inherits="HBSA_Web_Application.PlayerRegistrationRequest" %>
  ...
  <style type="text/css">
    ...
    <div style="max-height:99999px;">
        <table>
            <tr>
                <td>Your name:</td>
                <td><asp:TextBox ID="RequesterName_TextBox" runat="server"></asp:TextBox></td>
                <td></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="text-align:center"><asp:TextBox ID="Handicap_TextBox" runat="server" Width="36px"></asp:TextBox></td>
            ...
            <tr>
                ...
                <td><asp:TextBox ID="body_TextBox" runat="server" TextMode="MultiLine" Height="240"></asp:TextBox></td>
