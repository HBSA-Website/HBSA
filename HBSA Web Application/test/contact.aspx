            ...
            <asp:Panel ID="Agreement_Panel" runat="server" Visible="false">
                <table style="width: auto; margin-left: auto; margin-right: auto; border-collapse: collapse; background-color: #CCFFCC;">
                    <table style="width: auto; margin-left: auto; margin-right: auto; border-collapse: collapse; background-color: #CCFFCC;">
                        ...
                        <tr>
                            <td class="col2">
                                <b>Have you personally observed and made an assessment of the player's ability, over several frames?</b><br />
                        ...
                        <tr>
                            <td class="col2">
                                <b>Have you gathered all relevant information</b>? (such as; the players record in practice against other league players, their highest break, their handicaps in other leagues, whether the player plays existing cue sports, and if so to what standard)<br />
                        ...
                        <tr>
                            <td class="col2">
                                <span style="color:red; font-weight:bold">Do you understand that if you recommend a handicap which proves to be too high (due to not assessing the player properly, not declaring information about the player, etc) then POINTS REDUCTIONS will be applied.<br />
