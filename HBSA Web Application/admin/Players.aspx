    ...
    <div style="text-align: left; width: 100%">
        ...
        <script type="text/javascript">
            ...
            function autoComplete1_OnClientPopulating(sender, args) {
                sender.set_contextKey(document.getElementById("<%=LeagueSection_DropDownList.ClientID%>").value + '|' + document.getElementById("<%=Club_DropDownList.ClientID%>").value);
            }
                ...
                <ContentTemplate>
                    ...
                    <div style="text-align: left; width: 100%">
                                    ...
                                    <div style="border: 1px solid #0000FF; color: #0000FF; background-color: #99CCFF">
                                        <table style="text-align: left">
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="LeagueSection_DropDownList" runat="server" BackColor="#FFFFCC" AutoPostBack="True">
                        ...
                        <asp:Panel ID="Edit_Panel" runat="server" Visible="false">
                            <div id="divRegisterPlayer" style="border: 1px solid #000080; font-family: Arial, Helvetica, sans-serif; font-size: 8Pt; display: block; vertical-align: top; text-align: left; position: fixed; background-color: #99CCFF; width: 720px; top: 330px;">
                                ...
                                <table
                                    ...
                                    League secretary will receive an email with these details.<br />
                                                ...
                                                <div>
                                                    <table id="Controls_Table" runat="server">
                                                        <tr>
                                                            <th colspan="2">League</th>
                                                            <th>Club</th>
                                                            <th>Team</th>
                                                            <th colspan="2">Division/Section</th>
                                                       </tr>
                                                        <tr>
                                                            <td colspan="2" style="text-align: center">
                                                                <asp:DropDownList ID="editLeague_DropDownList" runat="server" BackColor="#FFFFCC" AutoPostBack="True"></asp:DropDownList></td>
                                                            <td>
                                                                <asp:DropDownList ID="editClubs_DropDownList" runat="server" BackColor="#FFFFCC" Width="140px" AutoPostBack="True"></asp:DropDownList></td>
                                                            ...
                                                            <td colspan="2" style="text-align: center">
                                                                <asp:DropDownList ID="editSection_DropDownList" runat="server" AutoPostBack="True" BackColor="#FFFFCC">
                                                                </asp:DropDownList>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                            <td id="ErrorTeamRow" runat="server" colspan="5" style="color: red; background: white;" visible="false">
                                                        ...
                                                        <tr>
                                                            <td></td>
                                                            <td>
                                                                <asp:TextBox ID="Forename_TextBox" runat="server" BackColor="#FFFFCC" Style="text-align: center;" Width="140px"></asp:TextBox>
                                                            </td>
                                                            <td style="text-align:center">
                                                                <asp:TextBox ID="Inits_TextBox" runat="server" BackColor="#FFFFCC" Style="text-align: center;" Width="32px"></asp:TextBox>
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="Surname_TextBox" runat="server" BackColor="#FFFFCC" Style="text-align: center;" Width="140px"></asp:TextBox>
                                                            </td>
                                                            <td style="text-align:center">
                                                        ...
                                                        <tr>
                                                            <td colspan="4">
                                                                <asp:TextBox ID="email_TextBox" runat="server" BackColor="#FFFFCC" Style="text-align: center;" Width="380px"></asp:TextBox>
                                                            </td>
                                                            <td colspan="2">
                                                                <asp:TextBox ID="TelNo_TextBox" runat="server" BackColor="#FFFFCC" Style="text-align: center;" Width="200px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="2" style="text-align: center">
                                                                <asp:CheckBox ID="Played_CheckBox" runat="server" Font-Bold="True" Text="Played" />
                                                            </td>
                                                            ...
                                                            <td colspan="2" style="text-align: center">
                                                                <asp:CheckBox ID="Over70_CheckBox" runat="server" Font-Bold="True" Text="Over 70 (80 for Vets)" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </div>
                                ...
                                <%--<asp:Button ID="AddSameName_Button" runat="server" Text="Add with same name" />--%></td>
                                        <td style="text-align: center">
