<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/admin/adminMasterPage.master" CodeBehind="EntryFormFullReport.aspx.vb" Inherits="HBSA_Web_Application.EntryFormFullReport" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <div style="text-align:left; width:100%">
        <h3>Entry Forms Detailed Report</h3>
    ...
    <script type="text/javascript">
        ...
        function InitializeRequest(sender, args) {
            if (sender._postBackSettings.sourceElement.id.indexOf("Export_Button") != -1) {
                ...
                iframe.src = "AdminDownload.aspx?source=EntryFormsFullReport&fileName=EntryFormsFullReport";
       ...
       <div style="text-align:left; width:100%">
        ...
        <asp:GridView ID="EntryFormsReport_GridView" runat="server" Font-Size="9pt" BackColor="White" BorderColor="Black" 
