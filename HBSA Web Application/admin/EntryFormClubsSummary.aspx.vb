...
Class EntryFormClubsSummary
    ...
    Protected Sub State_DropDownList_SelectedIndexChanged(sender As Object, e As EventArgs) Handles State_DropDownList.SelectedIndexChanged
        ...
        With EntryFormsClubs_GridView
            Dim EntryFormsSummaryTable As DataTable = ClubsSummaryReport(State_DropDownList.SelectedValue)
            Session("EntryFormsSummary") = EntryFormsSummaryTable
    ...
    Private Sub EntryFormsClubs_GridView_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles EntryFormsClubs_GridView.RowDataBound
        ...
        If e.Row.Cells.Count > 2 Then
            ...
            If State_DropDownList.SelectedValue < 0 Then
    ...
    Private Sub EntryFormsClubs_GridView_SelectedIndexChanging(sender As Object, e As GridViewSelectEventArgs) Handles EntryFormsClubs_GridView.SelectedIndexChanging
        ...
        Dim PaymentsList As DataTable = HBSAcodeLibrary.DebtsAndPayments.PaymentsList(EntryFormsClubs_GridView.Rows(e.NewSelectedIndex).Cells(2).Text, "League Entry Fee")
        ...
        AddPayment_Button.Visible = (EntryFormsClubs_GridView.Rows(e.NewSelectedIndex).Cells(7).Text > EntryFormsClubs_GridView.Rows(e.NewSelectedIndex).Cells(8).Text)
        ...
        Session("SummaryReportClubName") = EntryFormsClubs_GridView.Rows(e.NewSelectedIndex).Cells(3).Text
    ...
    Protected Sub OfferDialogueToAddAPayment()
        ...
        PaymentReason_DropDownList.SelectedValue = "League Entry Fee"
