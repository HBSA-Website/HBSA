...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <%--  <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <asp:Literal ID="Status_Literal" runat="server"></asp:Literal>
            ...
            <table>
                <tr><td>Contacts Report: </td><td><asp:Button ID="DownloadContactsReport_Button" runat="server" Text="Download Contacts Report" /></td></tr>
                <tr><td>Match Results: </td><td><asp:Button ID="MatchResults_Button" runat="server" Text="Download Match Results" /></td></tr>
            </table>
