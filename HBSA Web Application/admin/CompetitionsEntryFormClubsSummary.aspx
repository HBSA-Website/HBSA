<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/admin/adminMasterPage.master" CodeBehind="CompetitionsEntryFormClubsSummary.aspx.vb" Inherits="HBSA_Web_Application.CompetitionsEntryFormClubsSummary" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

        <div style="text-align:left; width:100%">
        <h3>Competitions Entry Forms Clubs Summary Report</h3>
    ...
    <script type="text/javascript">
        ...
        function InitializeRequest(sender, args) {
            if (sender._postBackSettings.sourceElement.id.indexOf("Export_Button") != -1) {
                ...
                iframe.src = "AdminDownload.aspx?source=CompEntryFormsSummary&fileName=CompetitionsEntryFormsSummary";
			                ...
			                <table>
                                ...
                                <tr>
                                    ...
                                    <td><asp:DropDownList ID="PaymentReason_DropDownList" runat="server" Enabled="false">
                                        <asp:ListItem Selected="True">Competition Entry Fee</asp:ListItem>
