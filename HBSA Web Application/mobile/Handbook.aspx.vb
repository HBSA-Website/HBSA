Public Class Handbook1
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If HBSAcodeLibrary.Utilities.HandbookExists Then
            ...
            Handbook_Label.Text = "The handbook is an Adobe Acrobat file (pdf). The document will be downloaded and displayed on your tablet or phone."
        Else
    ...
    Protected Sub DownLoadContent_Button_Click(sender As Object, e As EventArgs) Handles DownLoadContent_Button.Click
