<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/mobile/mobileMaster.Master" CodeBehind="LoginRegistration.aspx.vb" Inherits="HBSA_Web_Application.LoginRegistration1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="SmallHeader">
         <span onclick="helpDiv.style.display = 'block';" onmouseover="this.style.cursor='pointer';" >
            Team Representative's Login Registration<br />
        ...
        <div id="helpDiv" class="pageDiv" style="display:none;color:black;"
            ...
            <tr>
                <td style=" text-align:left; border:none;
                    ...
                    <u>Team login registration / change procedure</u></td>
            </tr>
            </table>
            <table>
                        ...
                        <td>   When the email arrives there are two options:
                            <table>
                                ...
                                <tr style="vertical-align:top">
                                     <td>3.2</td>
                                    <td>
                                        The email will contain your confirmation code. On the Huddersfield Snooker web site click Team Log in and enter your email address and
    ...
    <asp:Panel ID="loginPanel" runat="server" Visible="true">
        <table>
            <tr>
                ...
                <td><asp:DropDownList ID="leagueDropDownList" runat="server" AutoPostBack="true"/></td>
            </tr>
            <tr>
                <td style="text-align:right;">Division/Section:</td>
                <td><asp:DropDownList ID="sectionDropDownList" runat="server" AutoPostBack="true"/></td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="text-align:right;">Team letter:</td>
                <td><asp:DropDownList ID="teamDropDownList" runat="server" AutoPostBack="true"/></td>
            </tr>
            <tr>
