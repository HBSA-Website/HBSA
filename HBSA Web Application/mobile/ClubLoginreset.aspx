<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/mobile/mobileMaster.Master" CodeBehind="ClubLoginreset.aspx.vb" Inherits="HBSA_Web_Application.ClubLoginreset1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <u><b>Club Login Password Reset</b></u><br />
    ...
    <table border="1">
       ...
       <tr>
            <td>Club :</td>
            <td runat="server" id="club_cell" >            </td>
        </tr>
        <tr>
            <td>Password:</td>
            <td>
